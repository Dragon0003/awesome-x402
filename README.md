...
### Standards and EIPs
- [ERC‑3009](https://eips.ethereum.org/EIPS/eip-3009) — Transfer With Authorization**: meta-transaction transfers using EIP‑712 signatures, enabling gasless and recipient-submitted transfers. 
- [EIP‑712](https://eips.ethereum.org/EIPS/eip-712) — Typed Structured Data Hashing and Signing**: canonical typed signing used by modern wallets.
- [EIP‑2612](https://eips.ethereum.org/EIPS/eip-2612) — permit for ERC‑20**: approvals via signatures; often complementary to authorization-based flows.
